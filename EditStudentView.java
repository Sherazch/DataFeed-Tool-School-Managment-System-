...
//This class provides interface to update students record
	...
	EditStudentView() {
		...
		jb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				// Action
				Operations.updaterecord(Integer.parseInt(tf4.getText()),
						tf1.getText(), tf2.getText(), tf5.getText(),
						tf3.getText());
			}
		});
